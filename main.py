    ...
    for T in Temperatures:
        for P in Pressures:
            ...
            if __name__ == "__main__":
                ...
                dir = 'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/'.format(C,T, P)  # CHANGEHERE
                directories = [dir]
                ...
                for border in borders:
                    for ind, direct in enumerate(directories):
                        ...
                        datafile = 'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/48_TCP_Fe3C_010.data'.format(C,
                            T, P)  # CHANGEHERE
                        starting_bfile = 'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/48_TCP_Fe3C_010-BONDS.data'.format(C,
                            T, P)  # CHANGEHERE

                        start = time.time()
                        tal = Networkgen(datafile, starting_bfile)
                        tal.ovito_mols(
                            fout='D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/'.format(C,
                        ...
                        # fout_CH='D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/'.format(C,T, P)+system+'C_2-H_1'+str(border)
                        ...
                        fout = 'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/'.format(C,
                            T, P) + system + '_b' + str(  # CHANGEHERE
                            border)
                        fout_new = 'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/'.format(C,
                            T, P) + system + '_new_b' + str(  # CHANGEHERE
                            border)
                        fout_start = 'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/'.format(C,
                        ...
                        path_name_data_out = "D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/ovito_datafiles/".format(C,
                        ...
                        fout_intact = 'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/'.format(C,
            ...
            MoleculesIntact = pd.read_csv(
                'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/Fe2O3-200-iso-octane_IntactMols_0.3'.format(C,
                    T, P),
                sep='\t')
            """
            ...
            MoleculesIntact.to_excel(
                'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/Intact.xlsx'.format(C,
                    T, P),
                'Sheet 1', index=False)
            """
            ...
            plt.savefig(
                'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/Intact.png'.format(C,
                    T, P))
            ...
            NewMolecules = pd.read_csv(
                'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/Fe2O3-200-iso-octane_b0.3'.format(C,
                    T, P), sep='\t')
            """
            ...
            NewMolecules.to_excel(
                'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/NewMolecules.xlsx'.format(C,
                    T, P),
                'Sheet 1', index=False)
            """
            The above code is what translates from a text file to an excel file:
            ...
            while Index < NumberofBondTypes:
                ...
                plt.savefig(
                    'D:/PhD/TCPDecompositionExperiments/Completed/CutoffStudy/{}/{}/{}/processed/'.format(C,T, P) + GRAPHNAME + '.png')
                # plt.show()
                Index += 1
